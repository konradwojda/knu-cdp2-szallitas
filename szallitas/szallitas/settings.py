"""
Django settings for szallitas project.
...
SECRET_KEY = "django-insecure-ve^ndc3kurtu!tw$iqdbtke-*m-9-q%1799ipqyx0cdqr#-k#l"
...
WSGI_APPLICATION = "szallitas.wsgi.application"
